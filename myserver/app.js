...
app.use(cors()); //? agar api dapat diakses oleh react
app.use(logger('dev'));
...
//? not use multer cuz it's not a file upload

//? HOME
app.use('/', (req,res) =>{
  res.render('index',{
    title: 'eduwork services'
  });
});
// app.use('/', indexRouter);
...
app.use(function(err, req, res, next) {
  ...
  res.locals.error = req.app.get('env') === 'development' ? err : {}; //? jika env = development maka error ditampilkan, teteapi jika prodcution maka error tdk ditampilkan
